 ...
 * Se ha añadido además el modo de bajo consumo, de manera que la espera
 * a la pulsación de los botones se hace en modo sleep.
 ************************************************************/
...
int main(void)
{
    ...
    estado=0;
    SysCtlPeripheralSleepEnable(SYSCTL_PERIPH_GPIOJ);       //Habilitar el Pto J durante el Sleep
