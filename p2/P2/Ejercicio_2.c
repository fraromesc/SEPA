...
//Interrupción del timer: contador para el modo espera, y tiempo para saber el tiempo transcurrido desde la ejecución del programa
void IntTimer0(void)
{
...
int seg, min, hora;
// Función que imprime los mensajes por UART y da un formato a las variables de tiempo
